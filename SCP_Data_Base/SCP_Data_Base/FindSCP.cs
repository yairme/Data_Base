...
namespace SCP_Data_Base
{
    class FindSCP
    {
        ...
        public void FindScp()
        {
            ...
            string[] scp035 = new string[] { "SCP-035", "035", "SCP 035" };
            string[] scp049 = new string[] { "SCP-049", "049", "SCP 049" };
            string[] scp069 = new string[] { "SCP-069", "069", "SCP 069" };
        ...
        public void Return()
        {
            Console.WriteLine("Want to know anything else? (Yes/No)");
